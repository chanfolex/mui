export default {
  ...
  'menu.notify': '通知管理',
  'menu.notify.center': '我的通知',
  'menu.notify.detail': '通知详情示例',

  'menu.mailbox': '邮件管理',
  'menu.mailbox.mailin': '收件箱',
  'menu.mailbox.send': '发送箱',

  'menu.examine': '审核',
  'menu.examine.contract': '销售合同',
  'menu.examine.purchase': '采购合同',
  'menu.examine.contractpayment': '合同付款申请',
  'menu.examine.pcontractpayment': '采购付款申请',
  'menu.examine.paymentpre': '采购付款申请(主管)',
  'menu.examine.purchasepre': '采购合同(主管)',

  'menu.resource': '资源管理',

  'menu.resource.category': '产品分类',
  'menu.resource.types': '计量单位',
  'menu.resource.storage': '仓库管理',
  ...
  'menu.purchase.supporter': '供应商管理',
  'menu.purchase.recorder': '申请单记录',
  'menu.purchase.payment': '我的付款申请',
  'menu.purchase.insert': '新增合同',
  'menu.purchase.inquiry': '销售询价',
  'menu.purchase.contract': '合同记录',
  'menu.purchase.process': '工艺单记录',
  'menu.purchase.addform': '新增采购单',
  'menu.purchase.editform': '编辑采购单',
  'menu.purchase.contractadd': '销售新增采购',

  'menu.sales': '库存管理',
  'menu.sales.storage': '库存查询',
  'menu.sales.insert': '采购入库单',
  'menu.sales.export': '销售出库单',
  'menu.sales.insert_recorder': '入库记录',
  'menu.sales.export_recorder': '出库记录',
  'menu.sales.exchange': '调拨单',
  ...
  'menu.paper': '单证管理',
  'menu.paper.contract': '待发货合同',
  'menu.paper.payment': '我的付款申请',
  'menu.paper.clearance': '报关记录',
  ...
  'app.analysis.payments': '付款数量',
  'app.analysis.conversion-rate': '转化率',
  'app.analysis.operational-effect': '合同新增',
  ...
  'app.analysis.channel.stores': '业务',
  ...
  'app.settings.menuMap.mail': '邮箱设置',
  ...
  'app.settings.basic.update-mail': '更新邮箱设置',
