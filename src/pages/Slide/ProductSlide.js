...
@Form.create()
export default class ProductSlide extends PureComponent {
  componentDidMount() {
    this.fetchData();
  }
    ...
    return (
      ...
      >
        <Row>
          <Col span={8}>
            ...
            <div style={colClass}>
              ...
              <span style={{ color: '#333' }}> {formRow.category.name}</span>
            </div>
          ...
          <Col span={8}>
            ...
            <div style={colClass}>
              ...
              <span style={{ color: '#333' }}>{formRow.unit.name} </span>
            </div>
            <div style={colClass}>
              <span style={spanClass}>生产企业:</span>
              <span style={{ color: '#333' }}> {formRow.company}</span>
            </div>
            <div style={colClass}>
              <span style={spanClass}>生产许可证:</span>
              <span style={{ color: '#333' }}> {formRow.license}</span>
            </div>
          </Col>
          <Col span={8}>
            <div style={colClass}>
              <span style={spanClass}>库存数量:</span>
              <span style={{ color: '#333' }}> {formRow.num}</span>
            </div>
            <div style={colClass}>
        ...
        <Tabs defaultActiveKey="1" onChange={this.handleTabChange}>
          <TabPane tab="图片信息" key="1">
            <img src={formRow.cover} alt="" width="50%" height="50%" />
          </TabPane>
        </Tabs>
        ...
        <Row>
          <Col span={8}>
            <div style={colClass}>
              ...
              <span style={{ color: '#333' }}> {formRow.cuser}</span>
            </div>
            <div style={colClass}>
